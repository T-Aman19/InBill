...
app.use(
  ...
  cors({
    origin: config.isLocal
      ? "*"
      : ["https://app.inbill.tresiphi.com", "https://inbill.tresiphi.com", "https://tresiphi.com", "https://demo.inbill.tresiphi.com", "https://inbill-dev.tresiphi.com", "capacitor://localhost"],
