    ...
    return (_jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--color-bg)" }, children: [_jsx(TopBar, { current: "floor" }), _jsxs("div", { style: {
                    ...
                    padding: "0 20px", gap: 16,
                            ...
                            display: "flex", alignItems: "center", justifyContent: "center",
                                ...
                                }, children: [(payMutation.isPending || initiateUpiMutation.isPending) ? "Processing…" : mode === "upi" ? "Generate QR" : `Collect ${formatCurrency(Math.min(collectAmt, remaining))}`, !payMutation.isPending && !initiateUpiMutation.isPending && (_jsx("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M5 12h14M13 6l6 6-6 6" }) }))] })] })] }), upiPayment && (_jsx("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.55)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: 16 }, children: _jsxs("div", { style: { background: "var(--color-bg)", borderRadius: 20, padding: 32, width: "100%", maxWidth: 360, display: "flex", flexDirection: "column", alignItems: "center", gap: 20 }, children: [_jsxs("div", { style: { textAlign: "center" }, children: [_jsx("div", { style: { fontSize: 16, fontWeight: 700, color: "var(--color-ink)" }, children: "UPI Payment" }), _jsx("div", { style: { fontSize: 13, color: "var(--color-ink-3)", marginTop: 4 }, children: "Ask customer to scan with any UPI app" })] }), upiPayment.qrData.startsWith("upi://") ? (_jsx("div", { style: { background: "white", padding: 16, borderRadius: 12, border: "1px solid var(--color-line)" }, children: _jsx(QRCode, { value: upiPayment.qrData, size: 192 }) })) : (_jsxs("div", { style: { width: 192, height: 192, background: "var(--color-surface-2)", borderRadius: 12, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 8, border: "1px dashed var(--color-line-strong)" }, children: [_jsxs("svg", { width: "40", height: "40", viewBox: "0 0 24 24", fill: "none", stroke: "var(--color-ink-3)", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("rect", { x: "3", y: "3", width: "7", height: "7" }), _jsx("rect", { x: "14", y: "3", width: "7", height: "7" }), _jsx("rect", { x: "3", y: "14", width: "7", height: "7" }), _jsx("path", { d: "M14 14h.01M14 17h3M17 14h3v3M17 20h3" })] }), _jsx("div", { style: { fontSize: 11, color: "var(--color-ink-3)", textAlign: "center", padding: "0 12px" }, children: "Configure UPI VPA in Outlet Settings to show QR" })] })), _jsxs("div", { style: { textAlign: "center" }, children: [_jsx("div", { style: { fontSize: 28, fontWeight: 700, fontFamily: "var(--font-mono)", color: "var(--color-ink)" }, children: formatCurrency(upiPayment.amountDue) }), _jsx("div", { style: { fontSize: 11, color: "var(--color-ink-3)", marginTop: 4 }, children: upiPayment.mode === "stub" ? "Stub mode — use simulate button" : "Waiting for payment…" })] }), _jsxs("div", { style: { display: "flex", gap: 10, width: "100%" }, children: [_jsx("button", { onClick: () => { clearInterval(pollRef.current); setUpiPayment(null); }, style: { flex: 1, height: 44, borderRadius: 10, border: "1px solid var(--color-line-strong)", background: "transparent", color: "var(--color-ink)", fontSize: 14, fontFamily: "inherit", cursor: "pointer" }, children: "Cancel" }), _jsx("button", { onClick: () => simulateUpiMutation.mutate(upiPayment.paymentId), disabled: simulateUpiMutation.isPending, style: { flex: 1, height: 44, borderRadius: 10, border: "none", background: "var(--color-ink)", color: "var(--color-bg)", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer", opacity: simulateUpiMutation.isPending ? .5 : 1 }, children: simulateUpiMutation.isPending ? "Confirming…" : "Simulate ✓" })] }), _jsxs("div", { style: { fontSize: 11, color: "var(--color-ink-3)" }, children: ["Expires ", new Date(upiPayment.expiresAt).toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit" })] })] }) }))] }));
}
