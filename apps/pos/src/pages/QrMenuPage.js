...
export default function QrMenuPage() {
    ...
    return (_jsxs("div", { style: { minHeight: "100dvh", background: "#fafaf9", fontFamily: "system-ui, sans-serif", paddingBottom: cart.length > 0 ? 100 : 32 }, children: [toast && (_jsxs("div", { style: { position: "fixed", top: 16, left: "50%", transform: "translateX(-50%)", zIndex: 500, background: "#111", color: "#fff", padding: "12px 20px", borderRadius: 12, fontSize: 14, fontWeight: 600, whiteSpace: "nowrap", boxShadow: "0 4px 20px rgba(0,0,0,.25)" }, children: ["\u2713 ", toast] })), _jsxs("div", { style: { background: "#111", color: "#fff", padding: "20px 20px 16px", position: "sticky", top: 0, zIndex: 10 }, children: [_jsx("div", { style: { fontSize: 20, fontWeight: 700 }, children: outlet?.name }), outlet?.address && _jsx("div", { style: { fontSize: 12, opacity: .65, marginTop: 3 }, children: outlet.address })] }), orderId && orderStatus && STATUS_BANNER[orderStatus] && (_jsxs("div", { style: { background: STATUS_BANNER[orderStatus].bg, color: STATUS_BANNER[orderStatus].fg, padding: "10px 16px", fontSize: 13, fontWeight: 600, display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #f0f0f0" }, children: [orderStatus === "kot_sent" && (_jsx("span", { style: { width: 8, height: 8, borderRadius: "50%", background: "currentColor", display: "inline-block", animation: "pulse 1.5s ease-in-out infinite" } })), STATUS_BANNER[orderStatus].label] })), sentItems.length > 0 && (_jsxs("div", { style: { background: "#fff", borderBottom: "1px solid #f0f0f0" }, children: [_jsxs("button", { onClick: () => setShowSentItems((v) => !v), style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 16px", border: "none", background: "none", cursor: "pointer", fontFamily: "inherit" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("span", { style: { fontSize: 13, fontWeight: 700, color: "#1a7a1a" }, children: "\u2713 Ordered so far" }), _jsxs("span", { style: { fontSize: 12, color: "#888" }, children: [sentItems.reduce((s, i) => s + i.quantity, 0), " items \u00B7 ", fmt(sentTotal)] })] }), _jsx("span", { style: { fontSize: 18, color: "#555", transform: showSentItems ? "rotate(180deg)" : "none", transition: "transform .2s" }, children: "\u203A" })] }), showSentItems && (_jsxs("div", { style: { padding: "0 16px 16px" }, children: [sentItems.map((item, idx) => (_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", padding: "8px 0", borderTop: "1px solid #f5f5f5" }, children: [_jsxs("div", { children: [_jsxs("span", { style: { fontSize: 14 }, children: [item.name, item.variantName ? ` (${item.variantName})` : ""] }), item.modifiers && item.modifiers.length > 0 && (_jsx("div", { style: { fontSize: 12, color: "#888" }, children: item.modifiers.map((m) => m.name).join(", ") }))] }), _jsxs("div", { style: { display: "flex", gap: 12, alignItems: "center", flexShrink: 0 }, children: [_jsxs("span", { style: { fontSize: 13, color: "#888" }, children: ["\u00D7", item.quantity] }), _jsx("span", { style: { fontSize: 13, fontWeight: 600 }, children: fmt(Number(item.unitPrice) * item.quantity) })] })] }, idx))), orderId && (_jsxs("div", { style: { marginTop: 10, fontSize: 11, color: "#aaa", textAlign: "right" }, children: ["Order #", orderId.slice(-8).toUpperCase()] }))] }))] })), _jsx("div", { style: { display: "flex", gap: 8, padding: "14px 16px", overflowX: "auto", background: "#fff", borderBottom: "1px solid #f0f0f0", scrollbarWidth: "none" }, children: categories.map((cat) => (_jsx("button", { onClick: () => setActiveCategoryId(cat.id), style: { flexShrink: 0, padding: "8px 16px", borderRadius: 20, border: "1.5px solid " + (activeCategoryId === cat.id ? "#111" : "#e5e5e5"), background: activeCategoryId === cat.id ? "#111" : "#fff", color: activeCategoryId === cat.id ? "#fff" : "#555", fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }, children: cat.name }, cat.id))) }), _jsxs("div", { style: { padding: "12px 16px", display: "flex", flexDirection: "column", gap: 2 }, children: [visibleItems.length === 0 && (_jsx("div", { style: { textAlign: "center", padding: "48px 0", color: "#aaa", fontSize: 15 }, children: "No items in this category" })), visibleItems.map((item) => {
