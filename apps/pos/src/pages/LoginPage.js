...
export default function LoginPage() {
    ...
    // ── Main login ───────────────────────────────────────────────
    return (_jsxs("div", { style: { flex: 1, display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.1fr 1fr", gridTemplateRows: isMobile ? "auto 1fr" : undefined, overflow: isMobile ? "auto" : "hidden" }, children: [_jsxs("div", { style: {
