...
function MovementsTab() {
    ...
    return (_jsxs("div", { children: [_jsx("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 10 }, children: _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("input", { type: "date", value: exportFrom, onChange: (e) => setExportFrom(e.target.value), style: { height: 36, padding: "0 10px", border: "1px solid var(--color-line-strong)", borderRadius: 8, background: "var(--color-bg)", color: "var(--color-ink)", fontSize: 13, outline: "none", fontFamily: "inherit" } }), _jsx("span", { style: { color: "var(--color-ink-3)", fontSize: 13 }, children: "\u2013" }), _jsx("input", { type: "date", value: exportTo, onChange: (e) => setExportTo(e.target.value), style: { height: 36, padding: "0 10px", border: "1px solid var(--color-line-strong)", borderRadius: 8, background: "var(--color-bg)", color: "var(--color-ink)", fontSize: 13, outline: "none", fontFamily: "inherit" } }), _jsxs("button", { onClick: () => api.inventory.exportMovementsCsv(exportFrom, exportTo), style: { display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 8, border: "1px solid var(--color-line-strong)", background: "var(--color-surface)", color: "var(--color-ink-2)", fontSize: 12, fontFamily: "inherit", cursor: "pointer" }, children: [_jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3" }) }), "Export CSV"] })] }) }), _jsx("div", { style: { display: "flex", gap: 8, marginBottom: 20 }, children: ["all", "purchase", "sale", "waste", "adjustment"].map((t) => (_jsx("button", { onClick: () => setTypeFilter(t), style: { padding: "7px 16px", borderRadius: 20, border: "1px solid " + (typeFilter === t ? "var(--color-ink)" : "var(--color-line)"), background: typeFilter === t ? "var(--color-ink)" : "transparent", color: typeFilter === t ? "var(--color-bg)" : "var(--color-ink-3)", fontSize: 13, cursor: "pointer", fontFamily: "inherit", textTransform: "capitalize" }, children: t }, t))) }), _jsx("div", { style: { borderRadius: 12, border: "1px solid var(--color-line)", overflow: "hidden" }, children: _jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 13 }, children: [_jsx("thead", { children: _jsx("tr", { style: { background: "var(--color-surface-2)", borderBottom: "1px solid var(--color-line)" }, children: ["Ingredient", "Type", "Delta", "Note", "By", "Date"].map((h) => (_jsx("th", { style: { padding: "10px 16px", textAlign: "left", fontWeight: 500, color: "var(--color-ink-3)" }, children: h }, h))) }) }), _jsxs("tbody", { children: [filtered.map((m, i) => {
