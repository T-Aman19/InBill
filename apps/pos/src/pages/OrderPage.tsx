...
type OrderItem        = { id: string; menuItemId: string; variantId?: string | null; variantName?: string | null; name: string; unitPrice: string; quantity: number; isVoided: boolean; kotId: string | null; kotStatus?: string | null; modifiers: { modifierId: string; name: string; price: string }[] }
