...
function TableCard({ table, onClick, onFree }) {
...
function QueuePanel({ tables }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("button", { onClick: () => setOpen((v) => !v), style: {
                    ...
                    setShowModal(false); }, children: _jsxs("div", { style: { background: "var(--color-surface)", borderRadius: 16, padding: 24, width: 360, boxShadow: "var(--shadow-3)" }, children: [_jsx("div", { style: { fontWeight: 700, fontSize: 16, marginBottom: 18 }, children: "Add Walk-in" }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 12 }, children: [_jsxs("div", { children: [_jsx("label", { style: { fontSize: 12, color: "var(--color-ink-2)", fontWeight: 600, display: "block", marginBottom: 5 }, children: "Customer name *" }), _jsx("input", { autoFocus: true, value: form.customerName, onChange: (e) => setForm((f) => ({ ...f, customerName: e.target.value })), placeholder: "e.g. Rahul", style: { width: "100%", padding: "9px 12px", borderRadius: 8, border: "1px solid var(--color-line)", background: "var(--color-bg)", color: "var(--color-ink)", fontSize: 14, boxSizing: "border-box" }, onKeyDown: (e) => { if (e.key === "Enter" && form.customerName.trim())
                                                addMutation.mutate(); } })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: 12, color: "var(--color-ink-2)", fontWeight: 600, display: "block", marginBottom: 5 }, children: "Phone (optional)" }), _jsx("input", { value: form.customerPhone, onChange: (e) => setForm((f) => ({ ...f, customerPhone: e.target.value.replace(/\D/g, "").slice(0, 10) })), placeholder: "10-digit mobile (optional)", inputMode: "numeric", maxLength: 10, style: { width: "100%", padding: "9px 12px", borderRadius: 8, border: "1px solid var(--color-line)", background: "var(--color-bg)", color: "var(--color-ink)", fontSize: 14, boxSizing: "border-box" } })] }), _jsxs("div", { children: [_jsx("label", { style: { fontSize: 12, color: "var(--color-ink-2)", fontWeight: 600, display: "block", marginBottom: 8 }, children: "Party size" }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [_jsx("button", { onClick: () => setForm((f) => ({ ...f, partySize: Math.max(1, f.partySize - 1) })), style: { width: 32, height: 32, borderRadius: 8, border: "1px solid var(--color-line)", background: "var(--color-bg)", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--color-ink)" }, children: "\u2212" }), _jsx("span", { style: { fontFamily: "var(--font-mono)", fontSize: 20, fontWeight: 700, minWidth: 28, textAlign: "center" }, children: form.partySize }), _jsx("button", { onClick: () => setForm((f) => ({ ...f, partySize: Math.min(50, f.partySize + 1) })), style: { width: 32, height: 32, borderRadius: 8, border: "1px solid var(--color-line)", background: "var(--color-bg)", fontSize: 18, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--color-ink)" }, children: "+" })] })] }), formError && _jsx("div", { style: { fontSize: 12, color: "var(--color-red)" }, children: formError })] }), _jsxs("div", { style: { display: "flex", gap: 8, marginTop: 20 }, children: [_jsx("button", { onClick: () => setShowModal(false), style: { flex: 1, padding: "10px", borderRadius: 8, border: "1px solid var(--color-line)", background: "transparent", color: "var(--color-ink)", fontSize: 14, cursor: "pointer" }, children: "Cancel" }), _jsx("button", { onClick: () => {
                                        if (!form.customerName.trim()) {
                                            setFormError("Name is required");
                                            return;
                                        }
                                        if (form.customerPhone && !/^[6-9]\d{9}$/.test(form.customerPhone)) {
                                            setFormError("Enter a valid 10-digit Indian mobile number");
                                            return;
                                        }
                                        addMutation.mutate();
                                    }, disabled: addMutation.isPending, style: { flex: 2, padding: "10px", borderRadius: 8, border: "none", background: "var(--color-ink)", color: "var(--color-bg)", fontSize: 14, fontWeight: 600, cursor: "pointer", opacity: addMutation.isPending ? 0.6 : 1 }, children: addMutation.isPending ? "Adding…" : "Add to queue" })] })] }) })), seatEntry && (_jsx("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", zIndex: 50, display: "flex", alignItems: "center", justifyContent: "center" }, onClick: (e) => { if (e.target === e.currentTarget)
...
export default function FloorPage() {
    ...
    const freeTableMutation = useMutation({
        mutationFn: (tableId) => api.tables.updateTable(tableId, { status: "available" }),
    ...
    return (_jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--color-bg)", position: "relative" }, children: [_jsxs("div", { style: {
                    ...
                    padding: isMobile ? "0 12px" : "0 20px", gap: isMobile ? 8 : 14,
                }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }, children: [_jsx("div", { style: { color: "var(--color-ink)", flexShrink: 0 }, children: _jsx(LogoMark, { size: 28 }) }), _jsxs("div", { children: [_jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "var(--color-ink)", lineHeight: 1.15 }, children: outletName }), displaySetupCode ? (_jsx("button", { onClick: copyCode, style: { background: "none", border: "none", padding: 0, cursor: "pointer" }, children: _jsx("span", { style: { fontSize: 10, fontFamily: "var(--font-mono)", letterSpacing: ".06em", color: copied ? "var(--v2-marigold-ink)" : "var(--color-ink-4)", fontWeight: 500, transition: "color .15s" }, children: copied ? "Copied!" : displaySetupCode }) })) : (_jsx("div", { style: { fontSize: 10, color: "var(--color-ink-4)" }, children: "Terminal 01" }))] })] }), hasTables && !isMobile && (_jsx("div", { style: { display: "flex", background: "var(--color-surface-2)", border: "1px solid var(--color-line)", borderRadius: 10, padding: 4, flexShrink: 0 }, children: ([
                            { label: "Free", dot: "green", val: stats.free },
                            { label: "Open", dot: "amber", val: stats.open },
                            { label: "Billed", dot: "red", val: stats.billed },
                        ]).map((s, i, arr) => (_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 5, padding: "4px 11px", borderRight: i < arr.length - 1 ? "1px solid var(--color-line)" : "none", fontSize: 12 }, children: [_jsx("span", { className: `dot ${s.dot}` }), _jsx("span", { style: { color: "var(--color-ink-3)" }, children: s.label }), _jsx("span", { style: { fontWeight: 600, fontFamily: "var(--font-mono)" }, children: s.val })] }, s.label))) })), _jsxs("button", { onClick: () => startOrder("takeaway"), disabled: creating, "data-tour": "takeaway", title: "Takeaway", style: { display: "flex", alignItems: "center", gap: 6, padding: isMobile ? 0 : "7px 13px", width: isMobile ? 32 : undefined, height: isMobile ? 32 : undefined, justifyContent: "center", borderRadius: 9, border: "1px solid var(--color-line-strong)", background: "var(--color-surface)", color: "var(--color-ink)", fontSize: 13, fontWeight: 500, cursor: creating ? "not-allowed" : "pointer", flexShrink: 0, opacity: creating ? .6 : 1 }, children: [_jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M5 8h14l-1.5 12a2 2 0 01-2 2h-9a2 2 0 01-2-2L5 8z" }), _jsx("path", { d: "M8 8V6a4 4 0 018 0v2" }), _jsx("path", { d: "M9 13h6" })] }), !isMobile && "Takeaway"] }), outlet?.settings?.deliveryEnabled && !isMobile && (_jsxs("button", { onClick: () => startOrder("delivery"), disabled: creating, style: { display: "flex", alignItems: "center", gap: 6, padding: "7px 13px", borderRadius: 9, border: "1px solid var(--color-line-strong)", background: "var(--color-surface)", color: "var(--color-ink)", fontSize: 13, fontWeight: 500, cursor: creating ? "not-allowed" : "pointer", flexShrink: 0, opacity: creating ? .6 : 1 }, children: [_jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M5 8h14M8 8V6a4 4 0 018 0v2" }), _jsx("rect", { x: "2", y: "8", width: "20", height: "12", rx: "2" }), _jsx("path", { d: "M12 12v4M10 14h4" })] }), "Delivery"] })), _jsx("div", { style: { flex: 1 } }), isMobile ? (_jsx("button", { onClick: () => setNavMenuOpen(true), title: "Menu", style: { background: "transparent", border: "1px solid var(--color-line)", color: "var(--color-ink-2)", width: 32, height: 32, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", flexShrink: 0 }, children: _jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("line", { x1: "3", y1: "6", x2: "21", y2: "6" }), _jsx("line", { x1: "3", y1: "12", x2: "21", y2: "12" }), _jsx("line", { x1: "3", y1: "18", x2: "21", y2: "18" })] }) })) : (_jsxs(_Fragment, { children: [_jsx("div", { style: { display: "flex", gap: 2, alignItems: "center" }, children: [
                                    ...
                                    return (_jsxs("button", { onClick: () => navigate({ to: n.path }), "data-tour": `nav-${n.id}`, style: {
                                ...
                                }) }), _jsx("button", { onClick: () => setRunTour(true), title: "Replay the guided tour", style: { background: "transparent", border: "1px solid var(--color-line)", color: "var(--color-ink-3)", width: 30, height: 30, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", flexShrink: 0 }, onMouseEnter: (e) => { e.currentTarget.style.background = "var(--color-surface-2)"; e.currentTarget.style.color = "var(--color-ink)"; }, onMouseLeave: (e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "var(--color-ink-3)"; }, children: _jsxs("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3" }), _jsx("line", { x1: "12", y1: "17", x2: "12.01", y2: "17" })] }) }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, paddingLeft: 14, borderLeft: "1px solid var(--color-line)", flexShrink: 0 }, children: [_jsx("div", { style: { width: 30, height: 30, borderRadius: "50%", background: "var(--color-accent-soft)", color: "var(--color-accent-ink)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700 }, children: initials(user?.name ?? "?") }), _jsxs("div", { style: { lineHeight: 1.2 }, children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, color: "var(--color-ink)" }, children: user?.name }), _jsx("div", { style: { fontSize: 10, color: "var(--color-ink-3)", textTransform: "capitalize" }, children: user?.role })] }), _jsx("button", { onClick: () => { logout(); navigate({ to: "/login" }); }, title: "Logout", style: { background: "transparent", border: "none", color: "var(--color-ink-3)", width: 30, height: 30, borderRadius: 7, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }, onMouseEnter: (e) => { e.currentTarget.style.background = "var(--color-surface-2)"; e.currentTarget.style.color = "var(--color-ink)"; }, onMouseLeave: (e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "var(--color-ink-3)"; }, children: _jsx("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M15 4h3a2 2 0 012 2v12a2 2 0 01-2 2h-3M10 17l-5-5 5-5M5 12h11" }) }) })] })] }))] }), isMobile && navMenuOpen && (_jsxs(_Fragment, { children: [_jsx("div", { onClick: () => setNavMenuOpen(false), className: "animate-overlay-in", style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.18)", zIndex: 40 } }), _jsxs("div", { className: "animate-slide-right", style: { position: "fixed", top: 0, right: 0, bottom: 0, width: 260, background: "var(--color-surface)", borderLeft: "1px solid var(--color-line)", boxShadow: "-12px 0 40px rgba(0,0,0,.12)", zIndex: 50, display: "flex", flexDirection: "column", padding: "16px 12px" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, padding: "0 6px 8px", borderBottom: "1px solid var(--color-line)", marginBottom: 8 }, children: [_jsx("div", { style: { width: 30, height: 30, borderRadius: "50%", background: "var(--color-accent-soft)", color: "var(--color-accent-ink)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, flexShrink: 0 }, children: initials(user?.name ?? "?") }), _jsxs("div", { style: { flex: 1, minWidth: 0, lineHeight: 1.2 }, children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, color: "var(--color-ink)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: user?.name }), _jsx("div", { style: { fontSize: 10, color: "var(--color-ink-3)", textTransform: "capitalize" }, children: user?.role })] }), _jsx("button", { onClick: () => setNavMenuOpen(false), style: { background: "transparent", border: "none", color: "var(--color-ink-3)", cursor: "pointer", padding: 4, borderRadius: 8, display: "flex", flexShrink: 0 }, children: _jsx("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M18 6L6 18M6 6l12 12" }) }) })] }), hasTables && (_jsx("div", { style: { display: "flex", gap: 6, padding: "0 6px 12px" }, children: ([
                                    { label: "Free", dot: "green", val: stats.free },
                                    { label: "Open", dot: "amber", val: stats.open },
                                    { label: "Billed", dot: "red", val: stats.billed },
                                ]).map((s) => (_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 4, fontSize: 11, background: "var(--color-surface-2)", border: "1px solid var(--color-line)", borderRadius: 8, padding: "4px 8px" }, children: [_jsx("span", { className: `dot ${s.dot}` }), _jsx("span", { style: { color: "var(--color-ink-3)" }, children: s.label }), _jsx("span", { style: { fontWeight: 600, fontFamily: "var(--font-mono)" }, children: s.val })] }, s.label))) })), outlet?.settings?.deliveryEnabled && (_jsxs("button", { onClick: () => { setNavMenuOpen(false); startOrder("delivery"); }, disabled: creating, style: { display: "flex", alignItems: "center", gap: 9, padding: "8px 10px", borderRadius: 7, border: "none", background: "transparent", color: "var(--color-ink-2)", fontSize: 13, fontWeight: 500, cursor: creating ? "not-allowed" : "pointer", textAlign: "left" }, children: [_jsxs("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M5 8h14M8 8V6a4 4 0 018 0v2" }), _jsx("rect", { x: "2", y: "8", width: "20", height: "12", rx: "2" }), _jsx("path", { d: "M12 12v4M10 14h4" })] }), "Delivery"] })), [
                                { id: "floor", label: "Floor", path: "/floor", show: user?.role !== "kitchen",
                                    icon: _jsxs("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("rect", { x: "3", y: "6", width: "18", height: "11", rx: "1.5" }), _jsx("path", { d: "M3 11h18M7 17v3M17 17v3" })] }) },
                                { id: "kds", label: "Kitchen", path: "/kds", show: user?.role !== "kitchen" && hasKitchenWorkflow,
                                    icon: _jsxs("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("rect", { x: "3", y: "4", width: "18", height: "13", rx: "2" }), _jsx("path", { d: "M3 8h18M7 12h4M7 14h7" }), _jsx("path", { d: "M9 17v3M15 17v3M6 20h12" })] }) },
                                ...
                                const active = n.id === "floor";
                                return (_jsxs("button", { onClick: () => { setNavMenuOpen(false); navigate({ to: n.path }); }, style: {
                            ...
                            }), _jsxs("button", { onClick: () => { setNavMenuOpen(false); setRunTour(true); }, style: { display: "flex", alignItems: "center", gap: 9, padding: "8px 10px", borderRadius: 7, border: "none", background: "transparent", color: "var(--color-ink-2)", fontSize: 13, fontWeight: 500, cursor: "pointer", textAlign: "left" }, children: [_jsxs("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3" }), _jsx("line", { x1: "12", y1: "17", x2: "12.01", y2: "17" })] }), "Replay tour"] }), _jsx("div", { style: { flex: 1 } }), _jsxs("button", { onClick: () => { logout(); navigate({ to: "/login" }); }, style: { display: "flex", alignItems: "center", gap: 9, padding: "8px 10px", borderRadius: 7, border: "none", background: "transparent", color: "var(--color-red)", fontSize: 13, fontWeight: 500, cursor: "pointer", textAlign: "left", borderTop: "1px solid var(--color-line)", marginTop: 8, paddingTop: 14 }, children: [_jsx("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M15 4h3a2 2 0 012 2v12a2 2 0 01-2 2h-3M10 17l-5-5 5-5M5 12h11" }) }), "Log out"] })] })] })), _jsx(QueuePanel, { tables: tables }), counterOrders.length > 0 && (_jsxs("div", { style: { flexShrink: 0, borderBottom: "1px solid var(--color-line)", background: "var(--color-surface)", padding: "12px 24px" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }, children: [_jsxs("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "var(--color-amber)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z" }), _jsx("line", { x1: "3", y1: "6", x2: "21", y2: "6" }), _jsx("path", { d: "M16 10a4 4 0 01-8 0" })] }), _jsx("span", { style: { fontSize: 11, fontWeight: 700, letterSpacing: ".06em", textTransform: "uppercase", color: "var(--color-ink-2)" }, children: "Counter" }), _jsx("span", { style: { fontSize: 11, fontFamily: "var(--font-mono)", fontWeight: 600, background: "rgba(251,146,60,.12)", color: "var(--color-amber)", border: "1px solid rgba(251,146,60,.25)", borderRadius: 20, padding: "1px 7px" }, children: counterOrders.length })] }), _jsx("div", { style: { display: "flex", gap: 10, overflowX: "auto", paddingBottom: 2 }, children: counterOrders.map((order) => {
