...
export default function PODetailPage() {
    ...
    if (isLoading) {
        return (_jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100vh" }, children: [_jsxs("div", { style: { height: 56, flexShrink: 0, background: "var(--color-surface)", borderBottom: "1px solid var(--color-line)", display: "flex", alignItems: "center", padding: "0 24px", gap: 10 }, children: [_jsxs("button", { onClick: () => navigate({ to: "/inventory" }), style: { display: "flex", alignItems: "center", gap: 5, padding: "6px 10px", borderRadius: 8, border: "none", background: "transparent", color: "var(--color-ink-2)", fontSize: 13, fontWeight: 500, cursor: "pointer" }, onMouseEnter: (e) => e.currentTarget.style.background = "var(--color-surface-2)", onMouseLeave: (e) => e.currentTarget.style.background = "transparent", children: [_jsx("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M15 18l-6-6 6-6" }) }), "Inventory"] }), _jsx("div", { style: { width: 1, height: 18, background: "var(--color-line)" } }), _jsx("span", { style: { fontSize: 14, fontWeight: 600, color: "var(--color-ink)" }, children: "Purchase Order" })] }), _jsx("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--color-ink-3)" }, children: "Loading\u2026" })] }));
    }
    if (!po) {
        return (_jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100vh" }, children: [_jsxs("div", { style: { height: 56, flexShrink: 0, background: "var(--color-surface)", borderBottom: "1px solid var(--color-line)", display: "flex", alignItems: "center", padding: "0 24px", gap: 10 }, children: [_jsxs("button", { onClick: () => navigate({ to: "/inventory" }), style: { display: "flex", alignItems: "center", gap: 5, padding: "6px 10px", borderRadius: 8, border: "none", background: "transparent", color: "var(--color-ink-2)", fontSize: 13, fontWeight: 500, cursor: "pointer" }, onMouseEnter: (e) => e.currentTarget.style.background = "var(--color-surface-2)", onMouseLeave: (e) => e.currentTarget.style.background = "transparent", children: [_jsx("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M15 18l-6-6 6-6" }) }), "Inventory"] }), _jsx("div", { style: { width: 1, height: 18, background: "var(--color-line)" } }), _jsx("span", { style: { fontSize: 14, fontWeight: 600, color: "var(--color-ink)" }, children: "Purchase Order" })] }), _jsx("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "var(--color-ink-3)" }, children: "Purchase order not found." })] }));
    }
