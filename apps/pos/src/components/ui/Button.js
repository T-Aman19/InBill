...
export function Button({ children, variant = "primary", size = "md", disabled, loading, className, onClick, type = "button", fullWidth }) {
    return (_jsx(motion.button, { type: type, onClick: onClick, disabled: disabled || loading, whileTap: { scale: disabled ? 1 : 0.96 }, whileHover: { scale: disabled ? 1 : 1.01 }, transition: { type: "spring", stiffness: 500, damping: 30 }, className: cn("inline-flex items-center justify-center font-medium transition-all duration-150 cursor-pointer select-none", "disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none", variants[variant], sizes[size], fullWidth && "w-full", className), children: loading ? (_jsxs("svg", { className: "animate-spin w-4 h-4", viewBox: "0 0 24 24", fill: "none", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z" })] })) : children }));
}
