...
export function TopBar({ current, stats, onTakeaway, onDelivery }) {
    ...
    const nav = (to) => () => navigate({ to: to === "floor" ? "/floor" : to === "kds" ? "/kds" : "/manager" });
    return (_jsxs("div", { style: {
            ...
            padding: "0 20px", gap: 20,
                    ...
                    { k: "billed", label: "Billed", dot: "red", val: stats.billed },
                        ...
                        .map((id) => {
                        const labels = { floor: "Floor", kds: "Kitchen", manager: "Manager" };
                        const icons = {
                        ...
                        return (_jsxs("button", { onClick: nav(id), style: {
                                ...
                                transition: "all .1s",
                            }, children: [icons[id], labels[id]] }, id));
                    })] }), _jsxs("div", { style: {
